...
__license__   = 'GPL v3'
__copyright__ = '2011, Grant Drake <grant.drake@gmail.com>, 2019-2020 additions by David Forrester <davidfor@internode.on.net>'
...
from calibre.gui2 import gprefs, error_dialog, UNDEFINED_QDATETIME, info_dialog, Application
from calibre.gui2.actions import menu_action_unique_name
from calibre.gui2.complete2 import EditWithComplete
from calibre.gui2.keyboard import ShortcutConfig
from calibre.gui2.widgets import EnLineEdit
from calibre.utils.config import config_dir, tweaks
from calibre.utils.date import now, utcnow, format_date, qt_to_dt, UNDEFINED_DATE
...
#         debug_print("DateTableWidgetItem::__init__ - date_read=", date_read)
        ...
        if is_read_only:
            ...
            QTableWidgetItem.__init__(self, date_read, QtGui.QTableWidgetItem.UserType)
            self.setFlags(Qt.ItemIsSelectable|Qt.ItemIsEnabled)
        else:
            QTableWidgetItem.__init__(self, '', QtGui.QTableWidgetItem.UserType)
...
#             debug_print("DateTableWidgetItem::__init__ - dt=", dt)
    ...
    def __lt__(self, other):
        return self.date_read < other.date_read
...
#         if d <= UNDEFINED_QDATETIME:
        if not d or d <= UNDEFINED_QDATETIME or d == '':
            return ''
