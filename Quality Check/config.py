...
PLUGIN_MENUS = OrderedDict([
       ...
       ('check_authors_non_ascii',  {'name': _('Check authors non ascii'),        'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 4, 'excludable': True,  'image': 'user_profile.png',                     'tooltip':_('Find authors with non-ascii names (e.g. with diatrics)')}),
...
PLUGIN_FIX_MENUS = OrderedDict([
       ...
       ('fix_author_ascii',         {'name': _('Rename author to ascii'),        'cat':'fix',  'group': 0, 'image': 'user_profile.png',               'tooltip':_('For the selected book(s) rename the title to remove any accents and diatrics characters')}),
