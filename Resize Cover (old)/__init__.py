...
class ActionResizeCover(InterfaceActionBase):
    '''
    ...
    actual_plugin           = 'calibre_plugins.resize_cover.action:ResizeCoverAction'
    ...
    def config_widget(self):
        ...
        if self.actual_plugin_:
            from calibre_plugins.resize_cover.config import ConfigWidget
