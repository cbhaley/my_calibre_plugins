...
class ActionUserCategory(InterfaceActionBase):
    '''
    ...
    actual_plugin           = 'calibre_plugins.user_category.action:UserCategoryAction'
    ...
    def config_widget(self):
        ...
        if self.actual_plugin_:
            from calibre_plugins.user_category.config import ConfigWidget
